...
////////////////////////////////////////////////////
    ...
    function confirmation() {
        global $_POST;
        if (MODULE_PAYMENT_2CHECKOUT_DIRECT == 'Inline') {
...
////////////////////////////////////////////////////
    ...
    function install() {
        ...
        $db->Execute("insert into " . TABLE_CONFIGURATION . " (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, set_function, date_added) values ('Checkout Mode', 'MODULE_PAYMENT_2CHECKOUT_DIRECT', 'Inline', 'Use Inline or Standard Checkout', '6', '3', 'zen_cfg_select_option(array(\'Inline\', \'Standard\'), ', now())");
